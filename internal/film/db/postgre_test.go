...
func TestGetActors(t *testing.T) {
	type mockBehavior func(films []film.Film, actorId uuid.UUID, err error)
	...
	testTable := []struct {
		...
		expectedError error
		expectedFilms []film.Film
	}{
		{
			name: "ok",

			context: context.Background(),
			mockBehavior: func(films []film.Film, actorId uuid.UUID, err error) {
