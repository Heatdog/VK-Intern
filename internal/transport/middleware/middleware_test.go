package middleware_transport_test
...
func TestMiddleware(t *testing.T) {
	type mockBehavior func(srvice *token_mock.TokenService, ctx context.Context, token string)
	...
	testTable := []struct {
	...
	}{
		{
			...
			mockBehavior: func(ts *token_mock.TokenService, ctx context.Context, token string) {},
		...
		},
		{
			...
			mockBehavior: func(srvice *token_mock.TokenService, ctx context.Context, token string) {},
